...
// Status mix: 14 operational, 4 degraded, 1 critical, 1 offline
const TOWERS = [
  // ── Delhi ────────────────────────────────────────────────
  { id: 'T-101', name: 'Delhi Central Tower',      lat: 28.6139, lng: 77.2090, status: 'operational', coverage_radius_km: 3.0, affected_users: 0 },
  { id: 'T-102', name: 'Delhi North Sector',       lat: 28.7041, lng: 77.1025, status: 'degraded',    coverage_radius_km: 2.5, affected_users: 1200 },
  ...
  { id: 'T-105', name: 'Mumbai Bandra Hub',        lat: 19.0596, lng: 72.8295, status: 'critical',    coverage_radius_km: 2.0, affected_users: 5400 },
  ...
  { id: 'T-108', name: 'Bengaluru Whitefield Hub', lat: 12.9698, lng: 77.7499, status: 'degraded',    coverage_radius_km: 3.0, affected_users: 2100 },
  ...
  { id: 'T-111', name: 'Chennai OMR Hub',          lat: 12.9010, lng: 80.2279, status: 'offline',     coverage_radius_km: 2.0, affected_users: 3200 },
  ...
  { id: 'T-115', name: 'Hyderabad Old City Tower', lat: 17.3616, lng: 78.4747, status: 'degraded',    coverage_radius_km: 2.0, affected_users: 980 },

  // ── Pune ─────────────────────────────────────────────────
  { id: 'T-116', name: 'Pune Hinjewadi Tower',     lat: 18.5912, lng: 73.7380, status: 'operational', coverage_radius_km: 2.0, affected_users: 0 },
  { id: 'T-117', name: 'Pune Kothrud Hub',         lat: 18.5074, lng: 73.8077, status: 'degraded',    coverage_radius_km: 2.0, affected_users: 750 },
